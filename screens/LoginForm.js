...
const Login = ({navigation}) => {
    ...
    const handleLogin = () => {
        ...
        axios({
          ...
          server.shutdown()
          console.log(e)
          alert('The user information is not found in database')
        }).finally(() => {
          setIsLoading(false)
        })
    }
    ...
    return  (
        ...
        <TextInput style={styles.InputStyle}
            ...
            <View style={styles.loginStyle}>
                <Text style={styles.textStyle}>If you don't have an account,register from here</Text>
                <Button title="Go to Register Page" onPress={() => handleRegister()} style={styles.buttonStyle}></Button>
            </View>
        <Button title="Login" onPress={handleLogin} style={styles.buttonStyle}></Button>
        </View>
    </SafeAreaView>
    )
